...
find /root/server_release/stock_backtest/instock/cache/hist -type f -mtime +30 -delete
find /root/server_release/stock_backtest/instock/cache/hist -type d -empty -mtime +30 -delete
